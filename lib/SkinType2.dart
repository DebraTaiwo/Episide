...
import 'package:epidise/lastpage.dart';
...
class SkinType2 extends StatefulWidget {
  const SkinType2({super.key});

  @override
  State<SkinType2> createState() => _SkinType2State();
}

class _SkinType2State extends State<SkinType2> {
        ...
        child: Column(
          ...
          children: [
            ...
            ReusableCard(
                ...
                colour: Answer1),
            SizedBox(height: 20),
            ReusableCard(labelText: 'DARK SPOT', onpress: () {
              setState(() {
...
// class SkinType2 extends StatelessWidget {
//   const SkinType2({super.key});
//
//   @override
//   Widget build(BuildContext context) {
...
//             SizedBox(height: 20),
//             ReusableCard(
//                 labelText: 'FINE LINES',
//                 onpress: () {},
//                 colour: Colors.tealAccent),
//             SizedBox(height: 20),
//             ReusableCard(
//                 labelText: 'LARGE PORES',
//                 onpress: () {},
//                 colour: Colors.tealAccent),
//             SizedBox(height: 20),
//             ReusableCard(
